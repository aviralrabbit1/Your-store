    ...
    <div>
      ...
      <div className='container-xxl'>
          <div className='row align-items-center'>
            <div className='col-2'>
              <h2>
                <Link className='text-white'>Your Store</Link>
              </h2>
            </div>
            <div className='col-5'>
        ...
        <div className='container-xxl'>
          <div className='row'>            
            <div className='col-12'>
              <div className='menu-bottom d-flex align-items-center me-5 gap-30'>
                <div>
                <div className="dropdown">
                  {/* we can add "btn btn-secondary to highlight the button" */}
                  <button class="btn dropdown-toggle gap-15 d-flex
                  bg-trasnparent border-color-white align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img className='me-2' src="https://cdn2.iconfinder.com/data/icons/ecommerce-app-ui-32-vol-1/32/Ecommerce-32-512.png"
                    height="20px" alt=""/>
